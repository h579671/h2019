 ...
 */
@WebServlet(name="FeilpassordServlet", urlPatterns="/Oblig2.2/FeilpassordServlet")
public class FeilpassordServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Feil brukernavn eller passord, prøv igjen!</title>");
        out.println("</head>");
        out.println("<body>");
        
        out.println("<form method=\"post\">");
        out.println("  <fieldset>");
        out.println("    <legend>Feil brukernavn eller passord, prøv igjen!</legend>");
